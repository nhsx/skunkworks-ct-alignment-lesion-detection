...
"""
Modified by Roke Manor Research to run as a module of ai_ct_scans
"""
...
import ai_ct_scans.dino.utils as utils
import ai_ct_scans.dino.vision_transformer as vits
from ai_ct_scans.dino.vision_transformer import DINOHead
...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        + torchvision_archs
        + torch.hub.list("facebookresearch/xcit"),
