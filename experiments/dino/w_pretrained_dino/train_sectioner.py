...
threshold = 500
total_samples = 5000
filter_type = ["pretrained_dino"]
arch = "vit_small"
patch_size = 8

sectioner = sectioning.DinoSectioner(total_samples=total_samples, samples_per_image=50)
sectioner.load_dino_model(arch=arch, patch_size=patch_size)
