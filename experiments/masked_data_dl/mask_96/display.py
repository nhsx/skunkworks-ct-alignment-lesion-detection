"""
Display output from a model trained via mask_96/training.py. Results were unacceptably blurry - output from the
64x64 model was acceptable. 64x64 went on to be the largest masked region used for stakeholder discussion from this
point forwards
"""
