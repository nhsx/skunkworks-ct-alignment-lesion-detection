"""
Display output of an infiller model where a 32x32 masked region was present in input images, and a (5, 5) Gaussian
...
#     ax.imshow(im)
# f.suptitle('Masked slices with infilled region')
