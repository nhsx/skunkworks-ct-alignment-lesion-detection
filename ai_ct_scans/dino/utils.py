...
def init_distributed_mode(args):
    ...
    if "RANK" in os.environ and "WORLD_SIZE" in os.environ:
        ...
        args.gpu = (
            0  # changed to 0 by Roke Manor Research to enforce single GPU training
        )
    ...
    dist.init_process_group(
        backend="gloo",  # changed from "nccl" to "gloo" by Roke Manor Research to achieve single gpu training
