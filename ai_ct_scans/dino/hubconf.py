...
def dino_xcit_small_12_p16(pretrained=True, **kwargs):
    ...
    model = torch.hub.load(
        "facebookresearch/xcit", "xcit_small_12_p16", num_classes=0, **kwargs
    )
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
...
def dino_xcit_small_12_p8(pretrained=True, **kwargs):
    ...
    """
    model = torch.hub.load(
        "facebookresearch/xcit", "xcit_small_12_p8", num_classes=0, **kwargs
    )
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
...
def dino_xcit_medium_24_p16(pretrained=True, **kwargs):
    ...
    """
    model = torch.hub.load(
        "facebookresearch/xcit", "xcit_medium_24_p16", num_classes=0, **kwargs
    )
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
...
def dino_xcit_medium_24_p8(pretrained=True, **kwargs):
    ...
    """
    model = torch.hub.load(
        "facebookresearch/xcit", "xcit_medium_24_p8", num_classes=0, **kwargs
    )
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
